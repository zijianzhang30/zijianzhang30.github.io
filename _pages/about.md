  ...
  <main class="profile-content">
    ...
    <section class="profile-section">
      ...
      <div class="paper-list">
        ...
        <article class="paper-item">
          <div class="paper-thumb-pair">
            <img src="{{ '/assets/img/papers/roboconR1.jpg' | relative_url }}" alt="ROBOCON robot in competition">
            <img src="{{ '/assets/img/papers/roboconR1_2.jpg' | relative_url }}" alt="ROBOCON robot close-up">
          </div>
          <div>
            <div class="paper-title"><a href="{{ '/projects/robocon/' | relative_url }}">ROBOCON Robot Control.</a></div>
            <div class="paper-authors"><strong>Zijian Zhang</strong>.</div>
            <div class="paper-venue">MEI Competitive Robotics Lab, 2023.08 -- 2024.08.</div>
            <div class="paper-desc">Electrical control system development, communication networks, cascaded PID control, chassis control, and competition robot development.</div>
            <div class="paper-links"><a href="{{ '/projects/robocon/' | relative_url }}">Project</a></div>
          </div>
        </article>
      </div>
    </section>
